...
public class Build : MonoBehaviour
{
    ...
    public static void DoBuildAndroid()
    {
        ...
        string exportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../App/Chesskateers/android/UnityExport"));
    ...
    {
        string exportPath = Path.GetFullPath(Path.Combine(ProjectPath, "../App/Chesskateers/ios/UnityExport"));
