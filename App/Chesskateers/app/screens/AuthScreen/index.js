...
/**
 * This component is taken from https://github.com/mmazzarolo/react-native-login-animation-example
...
export default class AuthScreen extends Component {
  ...
  login = async (email, password) => {
    try {
      ...
      await this.handleLoginException(e);
    }
  };
  ...
  render() {
    const {isLoggedIn, isLoading, visibleForm} = this.state;
